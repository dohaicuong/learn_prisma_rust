...
pub mod post {
    ...
    impl<'a> Actions<'a> {
        pub fn create(self, title: title::Set, mut _params: Vec<SetParam>) -> Create<'a> {
        ...
        pub fn upsert(
            ...
            _create: (title::Set, Vec<SetParam>),
            _update: Vec<SetParam>,
        ) -> Upsert<'a> {
            let (title, mut _params) = _create;
            _params.push(title.into());
            Upsert::new(
                self.client._new_query_context(),
                QueryInfo::new("Post", _outputs()),
